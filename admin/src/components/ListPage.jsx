...
const ListPage = () => {
  ...
  return (
    <div className={doctorListStyles.container}>
        ...
        {loading &&(
         ...
         {!loading && filtered.length === 0 && (
            ...
            {displayed.map((doc)=>{
                ...
                const sorteddates= getSortedScheduledDates(scheduleMap);
                            ...
                            <div className={doctorListStyles.doctorInfoContainer}>
                                <div className={doctorListStyles.doctorHeader}>
                                    ...
                                    <div className={doctorListStyles.ratingContainer}>
                                        ...
                                        <button onClick={()=>toogle(id)}
                                            className={doctorListStyles.toogleButton(isopen)}>
                                                <EyeClosed size={18}/>
                                    ...
                                    <div className={doctorListStyles.actionContainer}>
                                        <div className='flex items-center gap-2'>
                                           <button onClick={()=> removeDoctor(id)} className={doctorListStyles.deleteButton}>
                                            ...
                                            <div className={doctorListStyles.fessLabel}>
                                                Fees
                                            </div>
            ...
            {filtered.Length > 6 &&(
                <div className={doctorListStyles.showMoreContainer}>
                    ...
                    className={doctorlisStyles.showMoreButton}>
      ...
      {/* You can continue the doctor list UI here using `displayed`, `loading`, etc. */}
    </div>
  );
};
